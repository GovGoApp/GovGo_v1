...
# Cores de similaridade dos editais (mapa)
_COLOR_SIMILARITY_GTE_90 = '#7f0000'
_COLOR_SIMILARITY_80_90 = '#d32f2f'
_COLOR_SIMILARITY_70_80 = '#ef5350'
_COLOR_SIMILARITY_60_70 = '#fb8c00'
_COLOR_SIMILARITY_LT_60 = '#f5e5c9'

SIMILARITY_COLOR_STOPS = [
    {
        'id': 'gte90',
        'label': '≥ 0.90',
        'min': 0.90,
...
styles = {
    ...
    'history_company': {
        'fontSize': '11px', 'color': _COLOR_SECONDARY,
...
styles['data_row'] = {
    ...
    'borderBottom': '1px solid #E0EAF9', 'padding': '2px 0', 'gap': '8px'
}
styles['data_label'] = {
    'fontWeight': '600', 'color': '#444', 'flex': '0 0 38%', 'paddingRight': '4px'
}
styles['data_value'] = {
    'color': '#222', 'flex': '1', 'textAlign': 'left', 'whiteSpace': 'normal', 'wordBreak': 'break-word'
}
styles['data_json'] = {
...
#gvg-main-panels { display: flex; flex-direction: column; }
#gvg-panels-track { display: flex; flex: 1 1 auto; width: 100%; height: 100%; position: relative; overflow: hidden; }
#gvg-panels-track > .gvg-slide { display: flex; }
#gvg-panels-track > .gvg-slide:first-child { width: var(--gvg-left-slide-width); }
#gvg-panels-track > .gvg-slide:last-child { width: var(--gvg-right-slide-width); }
#gvg-panels-track > .gvg-slide > div { width: 100%; }

.gvg-panels-indicators { display: none; align-items: center; justify-content: center; gap: 16px; position: relative; width: 100%; }
.gvg-indicator-dot { width: 12px; height: 12px; border-radius: 50%; border: none; background: #D0D7E2; cursor: pointer; padding: 0; position: relative; z-index: 2; transition: background 0.2s ease, transform 0.2s ease; }
...
.gvg-tabs-wrapper { display: flex; flex-direction: column; height: 100%; min-height: 0; }
.gvg-tabs-parent { display: flex; flex-direction: column; height: 100%; min-height: 0; }
.gvg-tabs-parent .tab-list { position: sticky; top: 0; z-index: 5; background: #E0EAF9; padding-bottom: 6px; }
.gvg-tabs-content { flex: 1 1 auto; min-height: 0; overflow-y: auto; padding-top: 4px; display: flex; flex-direction: column; }
.gvg-tabs { border: none; background: transparent; display: flex; gap: 6px; flex-wrap: nowrap; width: 100%; }
...
@media (max-width: 768px) {
    .gvg-tabs-parent .tab-list { overflow-x: auto; }
    .gvg-tabs { overflow-x: auto; flex-wrap: nowrap; scrollbar-width: none; }
    .gvg-tabs::-webkit-scrollbar { display: none; }
    .gvg-tab, .gvg-tabs .tab { flex: 0 0 auto !important; min-width: 140px !important; }
}
