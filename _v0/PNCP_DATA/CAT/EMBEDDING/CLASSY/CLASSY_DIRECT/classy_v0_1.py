...
INPUT_FILE = INPUT_DIR + "\\INPUT_002.xlsx"
SHEET = "Sheet1"
...
OUTPUT_FILE = OUTPUT_DIR + f"OUTPUT_001_{TIMESTAMP}.xlsx"
CHECKPOINT_FILE = CHECKPOINT_DIR + f"CHECKPOINT_001_{TIMESTAMP}.pkl"
...
def get_embeddings(texts, model=EMBEDDING_MODEL, show_progress=True):
