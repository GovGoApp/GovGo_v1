...
INPUT_FILE = INPUT_PATH + "\\INPUT_002.xlsx"
SHEET = "Sheet1"
...
OUTPUT_FILE = OUTPUT_PATH + f"OUTPUT_002_{TIMESTAMP}.xlsx"
CHECKPOINT_FILE = CHECKPOINT_PATH + f"CHECKPOINT_002_{TIMESTAMP}.pkl"


# Constantes para controle de execução
MAX_WORKERS = 10 #os.cpu_count() * 4 # Número de threads para processamento paralelo
...
BATCH_SIZE = 100 # Tamanho do lote para processamento de embeddings (metade do valor em $!!!)
