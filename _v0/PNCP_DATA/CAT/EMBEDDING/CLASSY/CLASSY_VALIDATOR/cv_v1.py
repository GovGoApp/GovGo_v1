...
# Aumentado largura dos quadros TOP
TOP_BOX_STYLE = {
    'height': '300px',
    'overflow-y': 'auto',
    'padding': '15px',
...
def load_data():
    """Carrega dados do banco SQLite e randomiza a ordem"""
...
app.layout = dbc.Container([
    dbc.Row([
        dbc.Col([
            ...
            html.Div(id="item-id-display", className="text-center mb-2"),  # Exibição do ID_ITEM_CONTRATACAO
        ...
        dbc.Col([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    n_clicks=0,
                    style=TOP_BOX_STYLE)
                ], width=12//5) for i in range(5)  # Distribuir uniformemente
            ], className="g-0"),
...
def update_item_display(prev_clicks, next_clicks, key_submit, close_modal,
    ...
    # Reset dos estilos e seleções (necessário para qualquer mudança de item)
    empty_label = ""
    ...
    if trigger == 'close-modal':
        return current_data, no_update, no_update, no_update, no_update, \
               no_update, no_update, no_update, no_update, no_update, \
               no_update, no_update, no_update, no_update, no_update, \
...
for i in range(5):
    ...
    def toggle_selection(n_clicks, key_value, current_selections, current_style):
        ...
        # Para clique simples não precisamos mais verificar o n_clicks ser par
