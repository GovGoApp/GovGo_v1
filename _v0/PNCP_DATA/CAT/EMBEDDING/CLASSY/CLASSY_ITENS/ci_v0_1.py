...
TYPE_INPUT = "OC_IT"
INPUT_ITENS_PATH = ITENS_PATH + f"INPUT_ITENS_{TYPE_INPUT}\\"
...
WEIGHT_HIERARCHICAL = 1  # Peso para abordagem hierárquica
WEIGHT_DIRECT = 0   # Peso para abordagem direta
...
def process_input_file(input_number):
    ...
    OUTPUT_FILE = OUTPUT_ITENS_PATH + f"OUTPUT_ITEM_{input_num_str}_D{int(WEIGHT_DIRECT*10)}_H{int(WEIGHT_HIERARCHICAL*10)}_{TYPE_INPUT}.xlsx"
