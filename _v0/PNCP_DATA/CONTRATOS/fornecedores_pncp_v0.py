...
# Definindo os caminhos e nomes de arquivos
...
FILE_OUT = "CONTRATOS_PNCP_FORNCEDORES.xlsx"                    # Arquivo de saída
...
print("Agrupando os fornecedores e calculando número de contratos e soma de valorGlobal...")
df_resultado = df_total.groupby(["niFornecedor", "tipoPessoa", "nomeRazaoSocialFornecedor"], as_index=False).agg(
    numero_contratos=("niFornecedor", "count"),
    soma_valorGlobal=("valorGlobal", "sum")
)
print("Agrupamento concluído. Total de fornecedores agrupados:", len(df_resultado))

print("Ordenando os fornecedores por número de contratos (ordem decrescente)...")
