...
openai.api_key = "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"  # Insira sua API_KEY aqui
...
def generate_keywords(text):
    """
    Utiliza a API da OpenAI (modelo GPT-4o) para gerar uma lista de 5 a 10 palavras-chave a partir do texto.
    O resultado é uma string com as palavras-chave separadas por ponto e vírgula.
    """
    prompt = f"""
...
Use apenas palavras-chave e respeite o limite de 200 caracteres.
Texto: {text}
Exemplo: "Edital; Pregão Eletrôncio; Merenda Escolar; Terceirização; Entrega; Prazo; Documentação; Habilitação"
"""
    try:
...
def format_keywords(keywords_str):
    """
    Recebe uma string de palavras-chave separadas por ponto e vírgula e retorna
    uma string HTML com cada palavra envolvida em um <span> com classe 'keyword-chip'.
    """
    if not keywords_str:
        return "N/D"
