...
def main():
    console.print(Panel(
        ...
        title="[bold magenta]SISTEMA DE BUSCA POR SIMILARIDADE DE CONTRATAÇÕES v1.2[/bold magenta]",
        subtitle="[bold cyan]Integrado com pré-processamento configurável[/bold cyan]",
        expand=False
    ))
    ...
    while True:
        ...
        console.print("[bold cyan]Digite sua consulta ou um dos comandos:[/bold cyan]")
        console.print("[cyan]1[/cyan] - Selecionar outro embedding")
