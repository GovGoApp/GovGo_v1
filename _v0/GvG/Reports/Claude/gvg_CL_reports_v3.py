## GvG Reports v3 using Claude
# Varias modificações de Design. Ja está funcional, mas ainda não está 100% otimizado.
#  
import os
import sqlite3
import pandas as pd
...
assistants = [
    "asst_LkOV3lLggXAavj40gdR7hZ4D",  # PNCP_SQL_v0 // Assistente original
    "asst_o7FQefGAlMuBz0yETyR7b3mA",  # PNCP_SQL_v1 // Assistente com campos retirados
    "asst_Lf3lJg6enUnmtiT9LTevrDs8",  # PNCP_SQL_v2 // Assistente com campos retirados e campos essenciais
    "asst_I2ORXWjoGDiumco9AAknbX4z",   # PNCP_SQL_v3 // Assistente resumido
    "asst_FHf43YVJk8a6DGl4C0dGYDVC"   # PNCP_SQL_v4 // Assistente com classficação de itens
]

ASSISTENTE = 4 # Escolha o índice do assistente desejado (0, 1, 2, 3 ou 4)

assistant_id = assistants[ASSISTENTE]
model_id = "gpt-4o"
...
header = html.Div([
    ...
    html.Div([
        ...
        html.H4("Reports", style={'marginLeft': '15px', 'color': '#003A70'})
