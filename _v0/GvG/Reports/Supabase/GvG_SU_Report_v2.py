...
# Carregar OpenAI API Key do arquivo openai.env (se existir)
openai_env_path = os.path.join(os.path.dirname(__file__), 'openai.env')
...
api_key = config.get('OPENAI_API_KEY', "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")
client = OpenAI(api_key=api_key)
thread = client.beta.threads.create()

# Assistant ID - SUPABASE_SQL_v0
assistant_id = "asst_MoxO9SNrQt4313fJ8Lzqt7iA"
model_id = "gpt-4o"
...
header = html.Div([
    ...
    html.Div([
        ...
        html.H4("Supabase Reports v0", style={'marginLeft': '15px', 'color': '#003A70'})
