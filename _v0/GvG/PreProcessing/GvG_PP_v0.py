"""
Módulo para pré-processamento de texto com opções configuráveis.
Fornece funções para normalização e limpeza de textos para processamento de linguagem natural.
"""
