#!/usr/bin/env bash
# Wrapper idempotente para executar o pipeline no Cron da Render
...
mods = ['requests','openai','psycopg2','numpy','pandas','rich','dotenv']
...
# Executar pipeline com debug por padrão (pode sobrescrever via env)
