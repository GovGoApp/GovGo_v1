# =======================================================================
# [05I_UNIFIED_CATEGORIZER] CATEGORIZAÇÃO UNIFICADA - BATCH PARALLEL
# =======================================================================
# Combina 05G (single contract) + 05H (batch parallel) em um único arquivo
# Processa contratos entre last_categorization_date e last_embedding_date
# Paraleliza por dia usando workers adaptativos com Rich Progress
# =======================================================================
...
TOP_K = 5  # Top categorias para similarity search
...
# =======================================================================
# FUNÇÕES DE CATEGORIZAÇÃO INDIVIDUAL (do 05G)
# =======================================================================

def calculate_confidence(similarities):
    """Calcula confiança baseada nas similaridades"""
...
# =======================================================================
# FUNÇÕES DE SISTEMA E DATA MANAGEMENT (do 05H)
# =======================================================================
...
# =======================================================================
# FUNÇÕES DE PROCESSAMENTO PARALELO (do 05H)
# =======================================================================
...
def process_contract_batch(contract_ids, worker_id, date_str, progress, task_id, date_stats_shared):
    ...
    for contract_id in contract_ids:
        result = categorize_single_contract_fast(contract_id)
...
if __name__ == "__main__":
    """EXECUÇÃO PRINCIPAL DO 05I - CATEGORIZAÇÃO UNIFICADA"""
    
    console.print("=" * 80)
    console.print("🚀 05_CATEGORIZE - CATEGORIZAÇÃO UNIFICADA BATCH PARALLEL")
    console.print("=" * 80)
